...
class Todo {
    ...
    createDomElements(id) {
        ...
        const liClassExtend = ['li', 'items', 'list-group-item']
        this.li.classList.add(...liClassExtend);

        const btnClassessEdit = ['btn-edit', 'btn', 'btn-outline-primary', 'btn-sm'];
        const btnClassessDelete = ['btn-delete', 'btn', 'btn-outline-danger', 'btn-sm'];
        const btnClassessComplete = ['btn-complete', 'btn', 'btn-outline-success', 'btn-sm'];

        this.edit.classList.add(...btnClassessEdit);
        this.delete.classList.add(...btnClassessDelete);
        this.complete.classList.add(...btnClassessComplete);
